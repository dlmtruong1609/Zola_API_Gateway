...
router.put('/api/v0/users/profiles', authMiddleWare.isAuthRoleMember, accountServiceProxy)
...
router.put('/api/v0/users/:id', authMiddleWare.isAuthRoleAdmin, accountServiceProxy)
